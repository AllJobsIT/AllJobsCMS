...
from .choices.prompts import MethodChoice
...
def _replace_handler(prompt: dict, text: str):
...
def _append_handler(prompt: dict, text: str):
...
def process(request):
    ...
    prompt = get_prompt_by_id(prompt_idx)
    ...
    handlers = {
        MethodChoice.REPLACE: _replace_handler,
        MethodChoice.APPEND: _append_handler,
    }
